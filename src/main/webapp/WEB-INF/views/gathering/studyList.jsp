	...
	<section class="gathering">
			...
			<div class="ps__header__content swiper">
				...
				<div class="swiper-slide">
					...
					<ul class="ps__header__content-info">
						<li><p class="bold">스터디 주제</p></li>
						<li><p class="bold">스터디명</p></li>
		...
		<section class="ps-list-main">
			...
			<div class="ps-filter">
				...
				<select name="topic" id="s__topic">
					<option value="none">분야 미지정</option>
				...
				<input type="checkbox" id="s__status" name="study-status">
				<label for="s__status">모집중</label>
				<input type="checkbox" id="s__bookmark" name="study-bookmark">
				<label for="s__bookmark">찜한 스터디</label>
				
				<input type="button" class="s__enroll btn" onclick="location.href='<%= request.getContextPath()%>/gathering/studyEnrollView;'" value="스터디 생성">
