...
<form name="projectEnrollFrm"
	...
	<table id="tbl-project-enrollview">
		<tbody>
			...
			<tr>
				<td colspan="3" id="topic"><input type="radio" name="social">소셜네트워크
					<input type="radio" name="game">게임 <input type="radio"
					name="travel">여행 <input type="radio" name="finance">금융
					<input type="radio" name="ecommerce">이커머스</td>
			</tr>
			<tr></tr>
			<tr>
				<th>*지역</th>
			...
			<tr>
				<td width="150px;"><select name="job_code" id="job_code">
				...
				<td><input type="button" id="delete" value="삭제"
					onclick="deleteRow()"></input> <input type="button" id="add"
					value="추가" onclick="addRow()" /></td>
				<td id="plus"></td>
			</tr>
			<tr>
				<th>*기간 설정</th>
