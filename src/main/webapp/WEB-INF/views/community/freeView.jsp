...
<hr style="margin-top:20px;"  />  
	...
	<div id="boardViewDesc">
		<div><h4><%= fview.getCoTitle() %></h4></div>
		<hr style="margin-top:20px;"  />  
		<div><span id="boardViewWriter">글쓴이:&nbsp;&nbsp;<%=fview.getCoWriter() %></span> <br> <span id="boardViewRegDate"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(fview.getCoRegdate()) %></span></div>
	</div>
